...
--
-- Name: seq_hfj_res_link; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.seq_hfj_res_link
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.seq_hfj_res_link OWNER TO postgres;

--
-- Name: seq_hfj_res_ver; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.seq_hfj_res_ver
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.seq_hfj_res_ver OWNER TO postgres;

--
-- Name: seq_hfj_resource; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.seq_hfj_resource
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.seq_hfj_resource OWNER TO postgres;
...
--
-- Name: hfj_forced_id idx_forcedid_type_fid; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hfj_spidx_uri idx_sp_uri_hash_identity_v2; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hfj_spidx_uri idx_sp_uri_hash_uri_v2; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_forceid_fid; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: hfj_history_tag fk3gc37g8b2c9qcrrccw7s50inw; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hfj_res_tag fk4kiphkwif9illrg0jtooom2w1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: hfj_res_ver_prov fk_resverprov_resver_pid; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
